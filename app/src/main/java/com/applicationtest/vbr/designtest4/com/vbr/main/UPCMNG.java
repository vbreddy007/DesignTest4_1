...
import com.applicationtest.vbr.designtest4.com.vbr.contests.ContestsActivity;
import com.applicationtest.vbr.designtest4.com.vbr.contests.ContestsActivity1;
            ...
            protected Void doInBackground(Void... voids) {
                ...
                try
                {
                    ...
                    for(int i=0 ; i<jsonArray.length();i++)
                    {
                        ...
                        MyData mydata = new MyData(tempObject.getString("match_title"),
